      ...
      <div className="max-w-5xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <Avatar user={user} size="sm" className="ring-2 ring-white/20 group-hover:ring-brand-500/50 transition-all" />
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="md:hidden pb-4 flex flex-col gap-1 border-t border-white/10 pt-3">
            {navLinks.map(link => (
              <Link
                key={link.to}
                to={link.to}
